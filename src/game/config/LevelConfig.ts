...
export const SECTORS: SectorConfig[] = [
  {
    ...
    name: 'SECTOR 01',
    codename: 'DEEP SPACE',
    subtitle: 'RECONNAISSANCE PATROL',
    startSecond: 0,
    endSecond: 60,
    starSpeedMult: 1.0,
    nebulaColors: {
    ...
    enemyPool: ['scout', 'interceptor'],
    asteroidDensity: 0.35,
    debrisFrequency: 0.15,
    signatureEvent: 'NONE',
  },
  {
    id: 2,
    ...
    enemyPool: ['scout', 'interceptor', 'shooter'],
    asteroidDensity: 0.4,
  ...
  },
  {
    ...
    subtitle: 'FRACTURED MINERAL FIELD',
    startSecond: 120,
    endSecond: 180,
    starSpeedMult: 1.25,
    nebulaColors: {
    ...
    enemyPool: ['scout', 'interceptor', 'shooter', 'tank'],
    asteroidDensity: 0.7,
  ...
  },
  {
    ...
    subtitle: 'DERELICT GRAVEYARD // CAPITAL THREAT',
    startSecond: 180,
    endSecond: 240,
    starSpeedMult: 1.35,
    nebulaColors: {
    ...
    enemyPool: ['scout', 'shooter', 'tank', 'bomber'],
    asteroidDensity: 0.45,
    debrisFrequency: 0.55,
  ...
  },
  {
    ...
    name: 'SECTOR 05',
    codename: 'VOID ZONE',
    subtitle: 'GRAVITATIONAL ANOMALY',
    startSecond: 240,
    endSecond: 300,
    starSpeedMult: 1.45,
    nebulaColors: {
    ...
    enemyPool: ['interceptor', 'shooter', 'tank', 'bomber', 'elite'],
    asteroidDensity: 0.5,
  ...
  },
  {
    ...
    subtitle: 'ALL-OUT WARZONE // QUEEN INCOMING',
    startSecond: 300,
    endSecond: 360,
    starSpeedMult: 1.55,
    nebulaColors: {
    ...
    enemyPool: ['interceptor', 'tank', 'bomber', 'elite'],
    asteroidDensity: 0.55,
    debrisFrequency: 0.6,
  ...
  },
  {
    ...
    enemyPool: ['scout', 'interceptor', 'shooter', 'tank', 'bomber', 'elite'],
    asteroidDensity: 0.6,
    debrisFrequency: 0.65,
